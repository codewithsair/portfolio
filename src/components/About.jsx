      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <motion.div
            ...
            <p className='mb-6'>"Front-end developer with 1+ years of hands-on experience in building responsive, user-friendly websites and web applications. Proficient in HTML, CSS, JavaScript, and modern frameworks like ReactJS. Passionate about delivering clean, efficient code and creating engaging user interfaces. Proven ability to work in fast-paced environments and collaborate effectively with cross-functional teams."</p>
            {/* stats */}
